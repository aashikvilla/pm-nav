...
const PM_ROLES = [
  {
    ...
    label: "Consumer PM",
    description: "B2C products, growth-focused, user psychology",
  },
  {
    value: "growth" as const,
    label: "Growth PM",
    description: "Funnel optimization, experimentation, metrics",
  },
  {
    value: "technical" as const,
    label: "Technical PM",
    description: "APIs, infra products, engineering collaboration",
  },
  {
    value: "platform" as const,
    label: "Platform PM",
    description: "Internal tools, developer platforms, scalability",
  },
  {
    value: "ai" as const,
    label: "AI PM",
    description: "ML products, AI features, model evaluation",
  },
  {
    value: "b2b" as const,
    label: "B2B / Enterprise PM",
    description: "SaaS, customer success, enterprise sales cycles",
  },
]
...
export function ProfileForm({ defaultName }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-2xl mx-auto space-y-8">
      ...
      >
        {isSubmitting ? "Saving..." : "Start analysis →"}
      </button>
    </form>
  )
}
